...
describe("ico-214-factory-all-token-ok-test", function () {
	const hre = require("hardhat");

	let owner: SignerWithAddress, project: SignerWithAddress, liquidity: SignerWithAddress;
	let addr1: SignerWithAddress, addr2: SignerWithAddress, addr3: SignerWithAddress, addrs;
	let chainLinkAggregator: Contract, foo: Contract, cryptocommoditiesFactory: Contract, diamondLoupeContract: Contract, common: Contract, ico: Contract, vesting: Contract, token: Contract;
	...
	it("Should be able to claim Tokens", async() => {
		...
		const unvestedNumTokensWithDecimals2 = numTokensWithDecimals1 * BigInt(10) / BigInt(100);																				// unvested tokens
