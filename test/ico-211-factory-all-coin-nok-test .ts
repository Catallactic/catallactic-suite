...
describe("ico-211-factory-all-coin-nok-test", function () {
	const hre = require("hardhat");

	let owner: SignerWithAddress, project: SignerWithAddress, liquidity: SignerWithAddress;
	let addr1: SignerWithAddress, addr2: SignerWithAddress, addr3: SignerWithAddress, addrs;
	let chainLinkAggregator: Contract, cryptocommoditiesFactory: Contract, diamondLoupeContract: Contract, common: Contract, ico: Contract, token: Contract;
